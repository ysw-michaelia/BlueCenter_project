    ...
    companion object {
        ...
        private val MIGRATION_2_3 = object : Migration(2, 3) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL("ALTER TABLE Channel ADD COLUMN staticValue FLOAT DEFAULT 0 NOT NULL; ADD COLUMN startTime TIMESTAMP DEFAULT (GetDate()) NOT NULL; ADD COLUMN stopTime TIMESTAMP DEFAULT (GetDate()) NOT NULL;")
            }
        }
