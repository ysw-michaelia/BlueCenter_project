    ...
    companion object {
        ...
        private val MIGRATION_1_2 = object : Migration(1, 2) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE Channel ADD COLUMN isActivated INTEGER DEFAULT 0 NOT NULL")
            }
        }
        ...
        private val MIGRATION_2_3 = object : Migration(2, 3) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE Channel ADD COLUMN staticValue FLOAT DEFAULT 0 NOT NULL; ADD COLUMN startTime STRING DEFAULT \"00:00\" NOT NULL; ADD COLUMN stopTime STRING DEFAULT \"00:00\" NOT NULL;")
            }
        }
